...
#### 1.“大脑”
第一步，安装Arduino IDE
![environment_setup_1](environment_setup_1.png)
![environment_setup_2](environment_setup_2.png)
![environment_setup_3](environment_setup_3.png)
...
还有闪烁版
<video src="小灯闪烁.mp4" controls width="600"></video>
...
![最大兼容性](最大兼容性.png)
![WiFi代码](WiFi代码.png)
![WiFi代码——失败](WiFi代码——失败.png)

经过多次尝试，终于连上了！！！

![WiFi代码——成功](WiFi代码——成功.png)
...
##### 操作完成后，我突然遇见了一个尴尬的问题，就是我用手机操作，但没有可以另外录像的设备(人在图书馆)，于是又用电脑做了一遍
<video src="电脑端遥控器.mp4" controls width="600"></video>
